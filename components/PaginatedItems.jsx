...
const  PaginatedItems = ({ itemsPerPage, postedItems, catName })=> {
    ...
    >
    { itemsPerPage < postedItems.length && <ReactPaginate
        ...
        nextLabel={<ArrowForwardIosIcon style={{ color: '#3EBFC8', fontSize: 18, width: 150 }} />}
        onPageChange={handlePageClick}
        pageCount={pageCount}
        pageClassName={'item pagination-page '}
        pageRangeDisplayed={2}
        previousClassName={"item previous"}
        previousLabel={<ArrowBackIosIcon style={{ color: '#3EBFC8', fontSize: 18, width: 150 }} />}
