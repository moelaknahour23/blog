		...
		<div className='card postCard flex shadow-lg rounded-lg p-8 mb-4 items-center justify-center'>
			...
			<div className='pl-10'>
				...
				<div className='flex items-center pb-4'>
					...
					/>
					<span className='inline align-middle  ml-2 font-medium text-sm lg:text-lg'>
						{post.author.name}
					</span>
				</div>
			...
			{/* <div className="text-center">
                <Link href={`/post/${post.slug}`}>
                  <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block orangeColor text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
                </Link>
              </div> */}
		</div>
	);
