...
const AdjacentPostCard = ({ post, position }) => (
	<>
		...
		{position === 'LEFT' && (
			<div className='absolute arrow-btn left-0 text-center cursor-pointer blueColor rounded-full p-2 mt-28'>
				<svg
		...
		{position === 'RIGHT' && (
			<div className='absolute arrow-btn right-0 text-center cursor-pointer blueColor rounded-full p-2 mt-28'>
				<svg
					xmlns='http://www.w3.org/2000/svg'
					className='h-6 w-6 text-white w-full'
					fill='none'
